/**
 * ISO 3166-1 alpha-2 country reference for the optional profile nationality.
 * We store the 2-letter code; the name and flag are derived for display.
 */
...
/** True when `code` is a known ISO 3166-1 alpha-2 code we offer. */
export function isCountryCode(code: string): boolean {
  return BY_CODE.has(code);
}

/** English country name for a code, or undefined when unknown. */
export function countryName(code: string): string | undefined {
  return BY_CODE.get(code);
}

/** Regional-indicator flag emoji for a 2-letter code (e.g. "FR" → 🇫🇷). */
